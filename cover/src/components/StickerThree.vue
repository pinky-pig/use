...
<template>
  <div class="sticker-container rounded-md w-[200px] h-[170px] bg-transparent p-[6px] text-[var(--cover-main-color)]  border-[#457af7] border border-solid">
    <div 
    style="-webkit-text-stroke: 1px #457af7;"
